...
data class AppStrings(
    ...
    val memberUsernameNotFound: String,
    val memberUsernameInvalid: String,
    val memberAlreadyExists: String,
    val memberActionFailed: String,
...
private val faStrings = AppStrings(
    ...
    memberUsernameNotFound = "این نام کاربری وجود ندارد.",
    memberUsernameInvalid = "نام کاربری واردشده معتبر نیست.",
    memberAlreadyExists = "این کاربر قبلاً در گروه اضافه شده است.",
    memberActionFailed = "افزودن عضو انجام نشد. دوباره تلاش کن.",
...
private val enStrings = AppStrings(
    ...
    memberUsernameNotFound = "This username does not exist on the server.",
    memberUsernameInvalid = "The entered username is not valid.",
    memberAlreadyExists = "This user is already in the group.",
    memberActionFailed = "Could not add the member. Try again.",
